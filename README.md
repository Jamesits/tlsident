...
Collects TLS, HTTP2 and HTTP fingerprints of certain AI agents.
...
- [Sub2API TLS Fingerprint Collector](https://tls.sub2api.org/)
...
```bash
ANTHROPIC_BASE_URL='https://localhost:8443' ANTHROPIC_API_KEY='' ANTHROPIC_AUTH_TOKEN='dummy' NODE_TLS_REJECT_UNAUTHORIZED=0 claude "test"
```
